                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {customers.map((customer) => (
                    <tr key={customer.id}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{customer.contacts}</td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{customer.telephone}</td>
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                        {customer.opening_balance ? `KES ${customer.opening_balance.toLocaleString()}` : '-'}
                      </td>
                    </tr>
                  ))}
                </tbody>
